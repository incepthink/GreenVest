  ...
  return (
    <div className='max-w-screen my-8 text-2xl flex flex-col justify-center items-center'>
            <div className='md:hidden flex w-100 justify-beteen items-center'>
                <h2 className=" font-bold my-2">Our Mission</h2>
            </div>
            <h2 className="font-bold hidden md:block">Our Mission</h2>
        ...
        <div className='max-w-screen  flex md:flex-row flex-col justify-between p-12'>
            ...
            <div className="bg-white py-12 md:w-[30%] my-2 mx-auto rounded-xl w-[90%] shadow-sm shadow-[#04A6E7] flex justify-center items-center font-poppins cursor-pointer hover:scale-105 hover:duration-500">
            ...
            <div className="bg-white py-12 md:w-[30%] mx-auto my-2 rounded-xl w-[90%] shadow-sm shadow-[#04A6E7] flex justify-center items-center font-poppins  cursor-pointer hover:scale-105 hover:duration-500">
