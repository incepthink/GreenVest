...
const Header = () => {
  return (
    <div className='max-w-screen h-screen bg-[#04a6e71a] md:rounded-bl-[163px] rounded-bl-[80px]'>
        <div className='flex flex-col md:flex-row justify-around items-center'>
            <div className='md:w-[55%] w-[100%] md:px-20 px-8 md:py-24 py-8 flex-col font-bebas uppercase'>
                <h1 className='md:text-7xl text-5xl flex items-center'>
                    Turnkey ESG <div className='w-100 h-100'><Image src='/images/Header/Co2.png' alt="CO2" width={75} height={75} style={{objectFit:'contain'}} /></div>
                </h1>
                <h1 className='md:text-7xl text-[44px] items-center'>
                    <span className='text-[#04A6E7]'>marketplace</span> powered by carbon credit NFTs
                </h1>
                <h1 className='text-base md:text-xl md:my-4 items-center normal-case text-gray-400 font-poppins'>
                    Greenvest is an innovative platform providing smart and fractional ESG solutions. 
                    You can produce, finance and consume fractionalized carbon credit NFTs using the ecosystem.
                </h1>
                <div className='flex my-12 items-center font-poppins normal-case hidden md:flex'>
                    ...
                    <Link 
                        ...
                        style={{fontSize:"1.25rem"}}
                    >   
                        <PlayCircleOutline style={{fontSize:"2rem"}} className='text-[#04A6E7]' />
                        <button
                            className='text-[#04A6E7] flex ml-1 items-center'
                        >
                             Watch Video
                        </button>
                    </Link>
