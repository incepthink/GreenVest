...
const Visions = () => {
  return (
    <div className='max-w-screen flex md:flex-row flex-col justify-between p-12 border-b-2 border-gray-300'>
        ...
        <div className="bg-white md:w-[21%] rounded-tr-2xl rounded-tl-2xl w-[90%] shadow-md font-poppins  transform md:translate-x-0 -translate-x-4 cursor-pointer hover:scale-105 hover:duration-500">
        ...
        <div className="bg-white rounded-tr-2xl rounded-tl-2xl md:w-[21%] w-[90%] shadow-md font-poppins   md:transform md:-translate-y-8 md:translate-x-0 translate-x-16 cursor-pointer hover:scale-105 hover:duration-500">
