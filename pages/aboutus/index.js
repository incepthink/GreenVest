...
export default function Home() {
    return (
      <div>
          ...
          <div className="md:w-[90%] w-[95%]  flex flex-col md:flex-row mx-auto justify-center items-center my-4">
            <Image src="/images/flowChart3.png" alt="vision 1" className="shadow-md shadow-[#04A6E7]" width={650} height={650} style={{"objectFit":"contain", }} />
          </div>
