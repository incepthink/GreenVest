    ...
    return (
      <div>
          ...
          <div className="md:w-[90%] w-[95%]  flex flex-col md:flex-row mx-auto justify-between items-center my-4">
            <Image src="/images/flowChart3.png" alt="vision 1" className="shadow-md my-4 shadow-[#04A6E7]" width={600} height={600} style={{"objectFit":"contain", }} />
            <Image src="/images/Website.jpg" alt="vision 1" className="shadow-md my-4 shadow-[#04A6E7]" width={600} height={600} style={{"objectFit":"contain", }} />
          </div>
