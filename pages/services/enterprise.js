  ...
  return (
    <div>
        ...
        <div className='flex flex-col text-center items-center my-8 font-poppins'>
            ...
            <p className='text-slate-500 my-4 font-semibold'>A one-stop-shop for Enterprises to meet your ESG goals.</p>    
        </div>
        <div className='flex flex-col md:flex-row md:flex-wrap md:max-w-[90%]  w-100 mx-auto justify-between items-center my-12 font-poppins'>
            ...
            <div className='md:w-[30%] md:h-[50vh] p-2 text-center shadow-xl w-100  my-8 mx-auto items-center justify-center bg-[#04A6E7] text-white rounded-lg'>
            ...
            <div className='md:w-[30%] md:h-[50vh] p-2 text-center shadow-xl w-100  my-8 mx-auto items-center justify-center bg-white text-black rounded-lg'>
