...
const services = () => {
  return (
    <div>
        <Navbar />
        <div className='max-w-screen h-screen bg-service-background bg-cover  bg-contain bg-no-repeat'>
        ...
        <div className='flex flex-wrap w-[90%] font-poppins my-8 mx-auto'>
            ...
            <div className='flex flex-col w-[45%] mx-auto my-4'>
                ...
                <div className='flex flex-col'>
                    ...
                    <button className='px-6 py-2 text-white my-2 rounded-lg bg-[#04A6E7] w-[20%]'>Check</button>
                </div>
            </div>
            ...
            <div className='flex flex-col w-[95%] mx-auto my-8'>
                ...
                <div className='flex flex-col'>
                    ...
                    <button className='px-6 py-2 text-white my-2 rounded-lg bg-[#04A6E7] w-[10%]'>Check</button>
                </div>
            </div>
