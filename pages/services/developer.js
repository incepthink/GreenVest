  ...
  return (
    <div>
        ...
        <div className='flex flex-col text-center items-center my-8 font-poppins'>
            <h1 className='text-[#04A6E7] font-bold text-2xl uppercase'> developers </h1>
            <p className='text-slate-500 mt-4 font-semibold'>A one-stop-shop for Developers to meet your ESG goals.</p>    
        </div>
